...
const Group04 = () => {
  return (
    <div className="g04">
      <div className="container bg-SPDarkGreen my-24 px-0">
        <div className="py-16 text-center px-1">
          <h2 className="font-goodDogCool text-SPGreen text-5xl">We bring tradition</h2>
          <h2 className="text-5xl uppercase font-weight-light">To your plate</h2>
        </div>
