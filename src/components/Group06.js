      ...
      <div className="g06-marginTop"/>
        <div className="g06-main">
          <div className="container pt-16 pb-10 text-center">
            <h2 className="font-goodDogCool text-5xl sm:text-6xl">Discover</h2>
            <h2 className="g06TitleL2 text-3xl sm:text-5xl uppercase font-weight-light">Our new menu</h2>
          </div>
          <div className="g06-content container flex flex-col md:flex-row items-center justify-between pb-8">
