...
const Group03Element = (props) => {
  ...
  return (
    <div className={props.left ? "g03Element flex flex-col items-center sm:items-start text-center sm:text-left mt-10 sm:mt-0 px-10 sm:px-0 " : "g03Element flex flex-col items-center sm:items-start text-center sm:text-left mt-10 sm:mt-0 px-10 sm:px-0 sm:pl-20"}>
      <div className="flex">{brushes}</div>
      <h4 className="mt-3 font-goodDogCool text-2xl">{props.title}</h4>
      <p className="mt-6 font-thin">Lorem ipsum dolor sit amet, consectetur
